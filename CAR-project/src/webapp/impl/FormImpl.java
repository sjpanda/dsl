 ...
 *   <li>{@link webapp.impl.FormImpl#getAction <em>Action</em>}</li>
...
public class FormImpl extends TagImpl implements Form {
	...
	public Action getAction() {
		if (action != null && action.eIsProxy()) {
			...
			if (action != oldAction) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, WebappPackage.FORM__ACTION, oldAction, action));
			}
		}
		return action;
	}
	...
	public void setAction(Action newAction) {
		...
		action = newAction;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WebappPackage.FORM__ACTION, oldAction, action));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case WebappPackage.FORM__METHOD:
				return getMethod();
			case WebappPackage.FORM__ACTION:
