...
public class ValidatorImpl extends MinimalEObjectImpl.Container implements Validator {
	...
	protected EClass eStaticClass() {
		return WebappPackage.Literals.VALIDATOR;
	}
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WebappPackage.VALIDATOR__NAME, oldName, name));
	}
	...
	public void setPackage(String newPackage) {
		...
		package_ = newPackage;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WebappPackage.VALIDATOR__PACKAGE, oldPackage, package_));
	}
