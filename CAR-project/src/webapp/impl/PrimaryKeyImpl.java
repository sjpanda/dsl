 ...
 * <ul>
 *   <li>{@link webapp.impl.PrimaryKeyImpl#getColumn <em>Column</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class PrimaryKeyImpl extends MinimalEObjectImpl.Container implements PrimaryKey {
	...
	protected EClass eStaticClass() {
		return WebappPackage.Literals.PRIMARY_KEY;
	}
	...
	public EList<Column> getColumn() {
		if (column == null) {
			column = new EObjectResolvingEList<Column>(Column.class, this, WebappPackage.PRIMARY_KEY__COLUMN);
		}
		return column;
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case WebappPackage.PRIMARY_KEY__COLUMN:
				return getColumn();
		}
