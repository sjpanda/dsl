...
public class FieldImpl extends MinimalEObjectImpl.Container implements Field {
	...
	protected EClass eStaticClass() {
		return WebappPackage.Literals.FIELD;
	}
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WebappPackage.FIELD__NAME, oldName, name));
	}
	...
	public void setType(String newType) {
		...
		type = newType;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WebappPackage.FIELD__TYPE, oldType, type));
	}
	...
	public void setDefaultValue(String newDefaultValue) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WebappPackage.FIELD__DEFAULT_VALUE, oldDefaultValue, defaultValue));
	}
