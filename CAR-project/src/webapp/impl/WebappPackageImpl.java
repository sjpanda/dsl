...
public class WebappPackageImpl extends EPackageImpl implements WebappPackage {
	 ...
	 * @generated
	 */
	public EReference getModel_BusinessObject() {
	 ...
	 * @generated
	 */
	public EReference getAction_BusinessObject() {
	 ...
	 * @generated
	 */
	public EReference getInput_Action() {
	 ...
	 * @generated
	 */
	public EReference getInput_ButtonValue() {
	 ...
	 * @generated
	 */
	public EReference getInput_TextValue() {
	 ...
	 * @generated
	 */
	public EReference getInput_Validator() {
	 ...
	 * @generated
	 */
	public EReference getBusinessObject_Field() {
	 ...
	 * @generated
	 */
	public EReference getBusinessObject_Action() {
	...
	public EAttribute getBusinessObject_Package() {
		return (EAttribute)businessObjectEClass.getEStructuralFeatures().get(3);
	}
	 ...
	 * @generated
	 */
	public EReference getBusinessObject_BusinessObject() {
	 ...
	 * @generated
	 */
	public EReference getBusinessObject_Model() {
	...
	public void createPackageContents() {
		...
		createEReference(actionEClass, ACTION__BUSINESS_OBJECT);
		...
		createEReference(inputEClass, INPUT__ACTION);
		createEReference(inputEClass, INPUT__LABEL);
		createEReference(inputEClass, INPUT__BUTTON_VALUE);
		createEReference(inputEClass, INPUT__TEXT_VALUE);
		createEReference(inputEClass, INPUT__VALIDATOR);
		...
		createEReference(businessObjectEClass, BUSINESS_OBJECT__FIELD);
		createEAttribute(businessObjectEClass, BUSINESS_OBJECT__NAME);
		createEReference(businessObjectEClass, BUSINESS_OBJECT__ACTION);
		createEAttribute(businessObjectEClass, BUSINESS_OBJECT__PACKAGE);
		createEReference(businessObjectEClass, BUSINESS_OBJECT__BUSINESS_OBJECT);
		createEReference(businessObjectEClass, BUSINESS_OBJECT__MODEL);
	...
	public void initializePackageContents() {
		...
		messagesEClass.getESuperTypes().add(this.getTag());
		...
		initEReference(getWebApp_Model(), this.getModel(), null, "model", null, 1, 1, WebApp.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEReference(getAction_BusinessObject(), this.getBusinessObject(), null, "businessObject", null, 0, 1, Action.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEReference(getInput_Action(), this.getAction(), null, "action", null, 0, 1, Input.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getInput_Label(), this.getMapping(), null, "label", null, 0, 1, Input.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getInput_ButtonValue(), this.getMapping(), null, "buttonValue", null, 0, 1, Input.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getInput_TextValue(), this.getField(), null, "textValue", null, 0, 1, Input.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getInput_Validator(), this.getValidator(), null, "validator", null, 0, 1, Input.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEReference(getBusinessObject_Field(), this.getField(), null, "field", null, 0, -1, BusinessObject.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEReference(getBusinessObject_Action(), this.getAction(), null, "action", null, 0, -1, BusinessObject.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEReference(getBusinessObject_BusinessObject(), this.getBusinessObject(), null, "businessObject", null, 0, -1, BusinessObject.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getBusinessObject_Model(), this.getModel(), null, "model", null, 1, 1, BusinessObject.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
