 ...
 * <ul>
 *   <li>{@link webapp.impl.ModelImpl#getTable <em>Table</em>}</li>
 *   <li>{@link webapp.impl.ModelImpl#getDatabaseName <em>Database Name</em>}</li>
...
public class ModelImpl extends MinimalEObjectImpl.Container implements Model {
	...
	public EList<Table> getTable() {
		if (table == null) {
			table = new EObjectContainmentEList<Table>(Table.class, this, WebappPackage.MODEL__TABLE);
		}
		return table;
	}
	...
	public void setDatabaseName(String newDatabaseName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WebappPackage.MODEL__DATABASE_NAME, oldDatabaseName, databaseName));
	}
	...
	public void setUrl(String newUrl) {
		...
		url = newUrl;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WebappPackage.MODEL__URL, oldUrl, url));
	}
	...
	public void setUserName(String newUserName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WebappPackage.MODEL__USER_NAME, oldUserName, userName));
	}
	...
	public void setPassword(String newPassword) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WebappPackage.MODEL__PASSWORD, oldPassword, password));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case WebappPackage.MODEL__TABLE:
				return getTable();
			case WebappPackage.MODEL__DATABASE_NAME:
				return getDatabaseName();
			case WebappPackage.MODEL__URL:
				return getUrl();
			case WebappPackage.MODEL__USER_NAME:
				return getUserName();
