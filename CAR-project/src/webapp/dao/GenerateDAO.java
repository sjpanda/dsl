...
public class GenerateDAO
{
  ...
  protected final String TEXT_4 = "\";" + NL + "\t" + NL + "\tprivate Connection getConnection(){" + NL + "\t\ttry {" + NL + "\t\t\tfinal Context lContext = new InitialContext(); " + NL + "\t\t\tfinal DataSource lDataSource = (DataSource)lContext.lookup(RESOURCE_JDBC);" + NL + "\t\t\tfinal Connection lConnection = lDataSource.getConnection();" + NL + "\t\t\treturn lConnection;" + NL + "\t\t} catch (NamingException e) {" + NL + "\t\t\treturn null; " + NL + "\t\t} catch (SQLException e) {" + NL + "\t\t\treturn null;" + NL + "\t\t} " + NL + "\t}" + NL + "\t" + NL + "\tpublic String getAll(){" + NL + "\t\tConnection connect = getConnection();" + NL + "\t\ttry{" + NL + "\t\t\tif(connect == null)" + NL + "\t\t\t\treturn \"Failed to etablish a connection to datebase ";
  protected final String TEXT_5 = "\";" + NL + "\t\t\t" + NL + "\t\t\tfinal PreparedStatement lPreparedStatementCreation =" + NL + "\t\t\t\t\tconnect.prepareStatement(\"SELECT * FROM ";
  protected final String TEXT_6 = "\");" + NL + "\t\t\tResultSet resultSet = lPreparedStatementCreation.executeQuery();" + NL + "\t\t\treturn null;" + NL + "\t\t} catch (SQLException e) {" + NL + "\t\t\treturn \"SQLException : \" + e.getMessage();" + NL + "\t\t} " + NL + "\t}" + NL + "\t" + NL + "\t";
  ...
  protected final String TEXT_11 = "\";" + NL + "\t\t\t" + NL + "\t\t\tfinal PreparedStatement lPreparedStatementCreation =" + NL + "\t\t\t\t\tconnect.prepareStatement(\"UPDATE ";
  protected final String TEXT_12 = " SET ";
  protected final String TEXT_13 = " = \" + ";
  protected final String TEXT_14 = " + \" WHERE id = \" + id);" + NL + "\t\t\tlPreparedStatementCreation.executeUpdate();" + NL + "\t\t\treturn null;" + NL + "\t\t} catch (SQLException e) {" + NL + "\t\t\treturn \"SQLException : \" + e.getMessage();" + NL + "\t\t} " + NL + "\t}" + NL + "\t" + NL + "\t\t";
  ...
  protected final String TEXT_18 = "\";" + NL + "\t\t\t" + NL + "\t\t\tfinal PreparedStatement lPreparedStatementCreation =" + NL + "\t\t\t\t\tconnect.prepareStatement(\"INSERT INTO ";
  protected final String TEXT_19 = "(";
  protected final String TEXT_20 = ") VALUES(";
  protected final String TEXT_21 = ")\");" + NL + "\t\t\t";
  protected final String TEXT_22 = NL + "\t\t\tlPreparedStatementCreation.setObject(";
  protected final String TEXT_23 = ", ";
  protected final String TEXT_24 = "); " + NL + "\t\t\t";
  protected final String TEXT_25 = NL + "\t\t\tlPreparedStatementCreation.executeUpdate();" + NL + "\t\t\treturn null;" + NL + "\t\t} catch (SQLException e) {" + NL + "\t\t\treturn \"SQLException : \" + e.getMessage();" + NL + "\t\t} " + NL + "\t}" + NL + "}";
