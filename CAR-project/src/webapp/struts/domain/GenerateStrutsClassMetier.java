...
public class GenerateStrutsClassMetier
{
  protected static String nl;
  public static synchronized GenerateStrutsClassMetier create(String lineSeparator)
  {
    nl = lineSeparator;
    GenerateStrutsClassMetier result = new GenerateStrutsClassMetier();
    nl = null;
    return result;
  }
  ...
  protected final String TEXT_2 = ".domain;" + NL + "" + NL + "public class ";
