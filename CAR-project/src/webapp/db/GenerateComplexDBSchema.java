...
public class GenerateComplexDBSchema
{
  protected static String nl;
  public static synchronized GenerateComplexDBSchema create(String lineSeparator)
  {
    nl = lineSeparator;
    GenerateComplexDBSchema result = new GenerateComplexDBSchema();
    nl = null;
    return result;
  }
