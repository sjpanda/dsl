...
/**
 * This is the item provider adapter for a {@link webapp.ForeignKey} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ForeignKeyItemProvider
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(WebappPackage.Literals.FOREIGN_KEY__ON_DELETE);
			childrenFeatures.add(WebappPackage.Literals.FOREIGN_KEY__ON_UPDATE);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(WebappPackage.Literals.FOREIGN_KEY__ON_DELETE,
				 WebappFactory.eINSTANCE.createOnDelete()));

		newChildDescriptors.add
			(createChildParameter
				(WebappPackage.Literals.FOREIGN_KEY__ON_UPDATE,
				 WebappFactory.eINSTANCE.createOnUpdate()));
	}
