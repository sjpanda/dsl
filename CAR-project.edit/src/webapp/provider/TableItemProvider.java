...
/**
 * This is the item provider adapter for a {@link webapp.Table} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class TableItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 WebappPackage.Literals.TABLE__NAME,
				 true,
				 false,
				 false,
	...
	protected void addCharsetPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Table_charset_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Table_charset_feature", "_UI_Table_type"),
				 WebappPackage.Literals.TABLE__CHARSET,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(WebappPackage.Literals.TABLE__COLUMN);
			childrenFeatures.add(WebappPackage.Literals.TABLE__CONSTRAINT);
		}
