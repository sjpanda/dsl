...
/**
 * This is the item provider adapter for a {@link webapp.Check} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class CheckItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Check_expr_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Check_expr_feature", "_UI_Check_type"),
				 WebappPackage.Literals.CHECK__EXPR,
				 true,
				 false,
				 false,
	...
	public String getText(Object object) {
		String label = ((Check)object).getExpr();
