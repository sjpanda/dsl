...
/**
 * This is the item provider adapter for a {@link webapp.Detail} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class DetailItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Detail_precision_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Detail_precision_feature", "_UI_Detail_type"),
				 WebappPackage.Literals.DETAIL__PRECISION,
				 true,
				 false,
				 false,
	...
	protected void addScalePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Detail_scale_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Detail_scale_feature", "_UI_Detail_type"),
				 WebappPackage.Literals.DETAIL__SCALE,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.INTEGRAL_VALUE_IMAGE,
	...
	public String getText(Object object) {
		...
		return getString("_UI_Detail_type") + " " + detail.getPrecision();
	}
